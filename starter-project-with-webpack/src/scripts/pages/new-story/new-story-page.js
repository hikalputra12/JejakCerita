...
export default class NewStoryPage {
            ...
            <div class="form-control">
              ...
              <div class="new-form__description__container">
                <textarea
                  ...
                  name="description"
                  placeholder="Masukkan deskripsi cerita anda. Anda dapat menjelaskan apa semua yang anda lakukan, dimana, kapan, dll."
                ></textarea>
              </div>
            </div>
            <div class="form-control">
  ...
  #updateLatLngInput(latitude, longitude) {
    this.#form.elements.namedItem('latitude').value = parseFloat(latitude).toFixed(6);
    this.#form.elements.namedItem('longitude').value = parseFloat(longitude).toFixed(6);
  }
